                ...
                <div className="row mb-3">
                    <div className="col-md-7 mb-5">
                        <div className="contenedor-mapa mb-4 mb-md-0">
                            ...
                            <p className="text-center">El Alto, Zona Los Andes, Calle Esteban Balboa No. 10</p>
                            <Map
                    ...
                    <div className="col-md-5 pr-md-5 mt-5 mt-md-0 pt-5 pt-md-0">
                        <h2 className="text-center font-weight-bold mt-5 mt-md-0 mb-3">Centro Virgen Niña</h2>
                        <hr className="mb-3 mb-md-5"/>
